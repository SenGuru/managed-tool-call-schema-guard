...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `npm run check`                                                                      | Latest clean full rerun passed in 23.76 seconds with the retained browser temporarily paused: format, build, ESLint, script syntax, dry provider boundary, package boundary, typecheck, conformance, 273 JavaScript/TypeScript tests passed, 19 credentialed PostgreSQL tests skipped, and 5 Python tests passed. The dry provider boundary reported zero live trials, as required. An earlier bounded full run passed in 236.81 seconds under heavier host contention. The unrelated untracked `apps/` tree was preserved.                                                                                 |
...
| Fail-closed commercial release gate                                                  | Eight focused tests prove missing/stale/configured-only/incomplete/secret-bearing/wrong-revision evidence, unsafe permissions, symlinks and hash alteration fail closed; complete synthetic contract fixtures prove both target schemas. A real empty-evidence private-beta run exited `1` with verdict `no_go` and all ten required reports missing. Every report must bind the exact certified commit. Synthetic passing fixtures validate gate logic only; they are not commercial evidence.                                                                                                             |
...
passed with 273 JS/TS tests, 19 credentialed-PostgreSQL tests skipped by the
