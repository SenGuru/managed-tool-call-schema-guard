...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `npm run check`                                                                      | Latest full rerun passed in 236.81 seconds after bounding Vitest to four workers: format, build, ESLint, script syntax, dry provider boundary, package boundary, typecheck, conformance, 264 JavaScript/TypeScript tests passed, 19 credentialed PostgreSQL tests skipped, and 5 Python tests passed. An immediately preceding unbounded run exposed six subprocess timeout flakes; the same two files passed 15/15 in isolation, and the bounded complete rerun then passed without weakening assertions. The unrelated untracked `apps/` tree was preserved.                                              |
