...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `npm run check`                                                                      | Latest clean full rerun passed in 24.62 seconds with the retained browser temporarily paused: format, build, ESLint, script syntax, dry provider boundary, package boundary, typecheck, conformance, 273 JavaScript/TypeScript tests passed, 19 credentialed PostgreSQL tests skipped, and 5 Python tests passed. The dry provider boundary reported zero live trials, as required. An earlier bounded full run passed in 236.81 seconds under heavier host contention. The unrelated untracked `apps/` tree was preserved.                                                                                 |
