...
| Command                                            | Result                                                                                                                                                                                                                                                                |
| -------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `npm run check`                                    | latest clean rerun passed in 24.62 s with the retained browser temporarily paused: format, lint, scripts, package boundary, types, dry provider boundary and conformance; 273 JS/TS passed, 19 PostgreSQL skipped; 5 Python passed; zero live provider trials claimed |
