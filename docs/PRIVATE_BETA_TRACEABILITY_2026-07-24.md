...
| Action hold, shadow rollout and workload binding                                         | authenticated local/shared action-control records; bounded non-mutating shadow diff; workload-keyed challenge and fingerprint                                                                                                                                              | Core binding, migration, HMAC, API, SDK, CLI, Python, dashboard and PostgreSQL multi-instance tests                                                                           | Exact-source container exercised hold before reservation, shadow diff, workload binding, outage/recovery and restart; local in-app browser exercised the custom hold dialog and recovery        | **Proven** locally and in exact-source containers; separate-host exact-revision redeploy remains pending                                                  |
...
| Paying-customer dashboard                                                                | 14-route workflow dashboard with dedicated integration, validation, contracts, schemas, environments, actions, approvals, alerts, intelligence, evidence, access, usage/billing and tenant controls; raw evidence and the 30-operation workbench remain advanced fallbacks | DOM interaction tests cover routing, credential races, responsive overflow and dedicated workflows; all operator mutations are required outside the workbench-only fallback   | In-app browser exercised all 14 SPA routes, action hold/custom dialog, desktop/mobile navigation and zero 390-pixel overflow; production image serves the same dashboard and assets             | **Proven for the operator/API-key product boundary**; human session/role UX is blocked                                                                    |
...
| Deployment and migrations                                                                | pinned images, Compose overlays and backward-safe migrations                                                                                                                                                                                                               | Build, migration, PG and configuration tests                                                                                                                                  | Exact managed image on DreamHost and anchor image on DigitalOcean; migration/persistence and restart drills                                                                                     | **Proven in private staging**                                                                                                                             |
...
3. The dashboard is no longer called a complete customer account product. It
   ...
   routes, structured state, raw evidence disclosures and a 30-operation
...
| ---------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------- |
| `npm run check`                                                                                            | 2026-07-25 exact-source rerun passed: format, build, lint, script syntax, dry provider probe, package boundary, typecheck, conformance, 241 TypeScript tests passed, 18 PostgreSQL tests skipped, and 5 Python tests passed                            | Local/SQLite/in-memory                            |
...
| `npm run audit:container-e2e`                                                                              | 2026-07-25 final exact-source rerun passed in 137.416 s; fresh PostgreSQL, TLS anchor, two tenants, action hold/shadow/workload binding, all decision paths, outage/redrive, database and container restarts, persistence, hardening and log redaction | Exact-source production images on one Docker host |
