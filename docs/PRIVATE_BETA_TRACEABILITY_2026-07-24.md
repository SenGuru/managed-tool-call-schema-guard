...
| Website, pricing, activation and product-boundary claims                                 | private Next.js website including `/pricing` and `/start`                                                                                                                                                                                                                  | Lint, build, 18-route render tests, desktop/mobile in-app-browser inspection, both activation branches and dashboard handoff                            | Not deployed by this revision                                                                                              | **Proven as private source only** for open-core and operator-issued activation; self-service identity remains blocked |
...
| private website in-app-browser inspection                                                                  | Desktop and 390px mobile layouts, both activation branches, managed-dashboard navigation and zero horizontal overflow verified                                                                                                                      | Local browser only                                |
